...
def test_chrome_opener_can_open_fresh_raid_window():
    captured = {}
    ...
    context = opener.open_raid_window("https://example.com/status/456")
    ...
    assert context == OpenedRaidContext(
        normalized_url="https://example.com/status/456",
        opened_at=100.25,
        window_handle=None,
        profile_directory="Profile 3",
    )
