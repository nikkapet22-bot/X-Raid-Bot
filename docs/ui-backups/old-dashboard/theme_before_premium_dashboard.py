...
def build_application_stylesheet() -> str:
    ...
    {card_selector()}[profileStatus="stopped"] {{
        background-color: {ERROR_DIM};
        border: 1px solid #5a1a1a;
    }}
    ...
    QProgressBar#warmupProgressBar {{
        min-height: 10px;
        max-height: 10px;
        border: 1px solid {WARMUP_BORDER};
        border-radius: 5px;
    ...
    QProgressBar#warmupProgressBar::chunk {{
        border-radius: 4px;
        background-color: {WARMUP_BORDER};
    }}
    ...
    QPushButton[attentionPulseButton="true"] {{
        border-width: 1px;
    }}
    ...
    QPushButton[dashboardActionButton="true"][variant="quiet"]:hover {{
        background-color: {ELEVATED_BG};
        border-color: transparent;
    }}
    QPushButton[dashboardActionButton="true"][variant="quiet"]:pressed {{
        background-color: #11253f;
        border-color: transparent;
    }}
    ...
    QPushButton[variant="quiet"]:pressed {{
        background-color: #11253f; color: {PRIMARY_TEXT}; border-color: transparent;
    }}
